...
namespace WindowsFormsApplication6
{
    public partial class Form1 : Form
    {
        ...
        static int secHandLength = 90;
        static int minHandLength = 90;
        static int hourHandLength = 70;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = 1; i <= 12; i++)
            {
                ...
                g.DrawString(num, font, Brushes.CadetBlue, x - size.Width / 2, y - size.Height / 2);
                theta = theta - DegrPerHour;
            }

            g.DrawString(DateTime.Now.ToString(), font, Brushes.Blue, 60, 160);
